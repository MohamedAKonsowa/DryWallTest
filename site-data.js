...
const SERVICES = [
  {
    ...
    title: 'Drywall Installation in Rural KY & Southern IN | Louisville Drywall & Painting LLC',
    description:
      'Affordable drywall installation for rural Kentucky and Southern Indiana homes. Hung, taped, mudded, and finished. Free on-site estimates. Call (502) 546-2608.',
    image: '/images/work-vaulted.png',
    imageAlt: 'Drywall installation on a vaulted ceiling during a rural home remodel',
    intro:
      'Need new drywall hung in a bedroom, basement, garage, or addition? Louisville Drywall & Painting LLC installs drywall the right way — hung, taped, mudded, and finished — so your walls are ready for paint.',
    details: [
      'New construction and remodel drywall hanging',
  ...
  },
  {
    ...
    title: 'Drywall Repair in Rural KY & Southern IN | Louisville Drywall & Painting LLC',
    description:
      'Hole patching, crack repair, and water damage drywall fixes for rural Kentucky and Southern Indiana homes. Free estimates. Call (502) 546-2608.',
    image: '/images/work-beam.png',
    imageAlt: 'Drywall repair and finishing around a wood beam in a country home',
    intro:
      'Holes, cracks, water damage, or bad patches? We repair drywall in rural homes across Kentucky and Southern Indiana — from a single wall to whole-room fixes.',
    details: [
      'Hole and crack patching',
      'Water damage and stain repair',
      'Texture blending and seamless patches',
      'Ceiling and wall repairs in farmhouses and country homes',
    ],
  ...
  },
  {
    ...
    title: 'Drywall Finishing in Rural KY & Southern IN | Louisville Drywall & Painting LLC',
    description:
      'Smooth, paint-ready drywall finishing for rural Kentucky and Southern Indiana. Taping, mudding, and sanding. Free estimates. Call (502) 546-2608.',
    image: '/images/work-garage.png',
    imageAlt: 'Garage drywall taped and mudded for a smooth paint-ready finish',
    intro:
      'Already have drywall hung but need a professional finish? We tape, mud, and sand walls and ceilings until they are smooth and ready for primer and paint.',
    details: [
  ...
  },
  {
    ...
    title: 'Interior Painting in Rural KY & Southern IN | Louisville Drywall & Painting LLC',
    description:
      'Affordable interior painting for rural Kentucky and Southern Indiana homes. Rooms, basements, and touch-ups. You buy paint — we handle labor. Call (502) 546-2608.',
    image: '/images/basement.jpg',
    imageAlt: 'Interior painting prep on walls in a rural Kentucky home',
    intro:
      'Fresh paint transforms a room. We handle interior painting labor for rural homeowners — rooms, basements, trim, and touch-ups — while you choose and buy the paint.',
    details: [
      'Room and basement painting',
